...
const homeFilter = fifaData.filter(function(item){
...
console.log(homeFilter[0]['Home Team Name']);
//(b) Away Team name for 2014 world cup final
console.log(homeFilter[0]['Away Team Name']);
//(c) Home Team goals for 2014 world cup final
console.log(homeFilter[0]['Home Team Goals']);
//(d) Away Team goals for 2014 world cup final
console.log(homeFilter[0]['Away Team Goals']);
//(e) Winner of 2014 world cup final */
console.log(homeFilter[0]['Win conditions']);
...
function getWinnersByYear(data, getFinalsCB, getYearsCB, getWinnersCB, ) {
    ...
    const finals = getFinalsCB(data, getFinals)
...
function getAverageGoals(data) {
   const averageHomeGaols = data.reduce(function(acc,item){
    return acc + item['Home Team Goals'] + item['Away Team Goals'];

   },0)
   return (averageHomeGaols/data.length).toFixed(2);
 }
